...
class _DGConvNd(Module):
    ...
    def __setstate__(self, state):
        super(_DGConvNd, self).__setstate__(state)
        if not hasattr(self, 'padding_mode'):
            self.padding_mode = 'zeros'

class DGConv1d(_DGConvNd):
